...
public class SaviorEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SaviorEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public SaviorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SoulGauntletModEntities.SAVIOR.get(), world);
	}

	public SaviorEntity(EntityType<SaviorEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(SaviorEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
